...
<section class="page" id="C12">
<div class="subct">
<%@ include file="subct_top.conf" %>
<%for(int i=0;i<Volist.size();i++)
	{
	tour_viewVO Vo = Volist.get(i);
	if (Vo.getDcode_res().equals("도지정문화재")){
	%>
...
<section class="page" id="C13">
<div class="subct">
<%@ include file="subct_top.conf" %>
<%for(int i=0;i<Volist.size();i++)
	{
	tour_viewVO Vo = Volist.get(i);
	if (Vo.getDcode_res().equals("유적건조물")){
	%>
