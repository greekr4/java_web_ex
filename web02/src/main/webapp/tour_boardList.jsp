...
<%for(int i=0;i<mem.size();i++)
	...
	<td><%=mem2.getTour_board_num() %></td>
	<td><%=mem2.getTour_board_pidno() %></td>
	<td><%=mem2.getTour_board_tit() %></td>
	<td><textarea style="width: 150px;height: 80px;" name="" id="" cols="30" rows="10"><%=mem2.getTour_board_detail() %></textarea></td>
	<td><%=mem2.getTour_board_writer() %></td>
	<td><%=mem2.getTour_board_cdate() %></td>
	<td><%=mem2.getTour_board_img1() %><br><%=mem2.getTour_board_img2() %><br><%=mem2.getTour_board_img3() %><br><%=mem2.getTour_board_img4() %></td>
	<td><%=mem2.getTour_board_address() %></td>
	<td><%=mem2.getTour_board_tel() %></td>
	<td><%=mem2.getTour_board_views() %></td>
	<td><%=mem2.getTour_board_thumb() %></td>
	<td style="width:200px">
	<button style="margin:12px;" onclick="window.open('Send_EditTour_board?board_edit_no=<%=mem2.getTour_board_num() %>','수정','width=430,height=500,location=no,status=no,scrollbars=yes');">수정</button>
