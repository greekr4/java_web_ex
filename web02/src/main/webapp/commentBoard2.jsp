...
<%
ArrayList<tour_commentVO> Volist = (ArrayList<tour_commentVO>) request.getAttribute("tour_commentList");
tour_commentVO Vo = new tour_commentVO();
Vo = Volist.get(0);
%>   
...
<h4><%=Vo.getTour_comment_tit() %></h4>
	<ul class="board_ul">
		<li>
		
			<strong>작성자</strong><span class="user"><%=Vo.getTour_comment_name() %></span>
		</li>
		<li>
			<strong>작성일</strong><span class="cdate"><%=Vo.getTour_comment_tdate() %></span>
		</li>
	</ul>
	<div class="detailbox">
	<p><%=Vo.getTour_comment_detail() %></p>
	</div>
</div>
