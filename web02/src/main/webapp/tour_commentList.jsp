...
<div class="tb_wrap">
<button style="margin-bottom: 10px; padding: 12px 24px;" onclick="window.open('Send_AddTour_comment','추가','width=430,height=500,location=no,status=no,scrollbars=yes');">추가</button>
...
<%for(int i=0;i<mem.size();i++)
	...
	<td><%=mem2.getTour_comment_thumb() %></td>
	<td>
		<div class="btn_box">
	<button style="margin-right:5px;"onclick="window.open('Send_EditTour_comment?tour_comment_no=<%=mem2.getTour_comment_uninum() %>','수정','width=430,height=500,location=no,status=no,scrollbars=yes');">수정</button>
