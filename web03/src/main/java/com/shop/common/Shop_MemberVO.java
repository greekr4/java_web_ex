...
public class Shop_MemberVO {
	...
	public int getMcash() {return mcash;}
	public void setMcash(int mcash) {this.mcash = mcash;}
	public int getMpoint() {return mpoint;}
	public void setMpoint(int mpoint) {this.mpoint = mpoint;}
	public int getMgrade() {return mgrade;}
	public void setMgrade(int mgrade) {this.mgrade = mgrade;}
	public Date getMjday() {return mjday;}
	public void setMjday(Date mjday) {this.mjday = mjday;}
	public Date getMlatest() {return mlatest;}
