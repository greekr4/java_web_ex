...
<%
	...
	if(request.getParameter("bno")!=null) { int bno = Integer.parseInt(request.getParameter("bno")); } 
%>
<!DOCTYPE html>
<html>
<head>
...
<div id="content">
	<section class="con_wrap">
		...
		<form action="${path1 }/AddPaymentCtrl" method="post" name="join_form" onsubmit="return joinCheck(this)">
			<table class="table" id="lst_tb">
				<tbody>
					...
					<tr>
						<th>수량</th>
						<td>
							<input type="number" name="amount" min="1" max="${goods.amount }" value="1" required>
						</td>
					</tr>
					<tr>
						<th>단가</th>
