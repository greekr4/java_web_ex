...
<div class="loginbox">
    <div class="join-page">
      ...
      <h2>주문 상품</h2>
    <div class="line_div">
	<img alt="dd" src="./img/${BasketVo.gimage }" style="display:block; width: 30%; margin: 0 auto;">
	${vo.gname }
	<input style="width:10%;" value="${BasketVo.bamount }" readonly />
	<fmt:formatNumber value="${BasketVo.gprice}" pattern="#,###"/>원
	<input type="hidden" value="${BasketVo.gcode }" class="gcode"/>
	<input type="hidden" value="${BasketVo.bamount}" class="bamount"/>
	<input type="hidden" value="${BasketVo.gprice}" class="bprice"/>
	</div>
	<c:set var="t_price" value="${t_price + BasketVo.gprice * BasketVo.bamount}" />
  	</div>
  <div class="form">
  	<h2>구매 하기</h2>
